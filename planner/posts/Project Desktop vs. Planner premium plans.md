...
service: ghost
---
# Project Desktop vs. Planner premium plans

As part of the rollout of Microsoft Planner premium plans, I need to be able to explain the differences to the users.
### Some Background
...
Microsoft **Planner** launched in **2016** and built for teams, part of Microsoft 365 work or school subscription. It is not in Office 365 i.e., not for personal use. There are Web, Android, and iOS apps unlike Project Desktop. It was announced at [Ignite 2019](https://lnkd.in/eaJS77JZ) that Planner is now part of the "Microsoft task ecosystem". In the Spring of 2024, the new Planner app in Teams became generally available and "Tasks by Planner" and the [To Do](https://to-do.office.com/) app in Teams were renamed to "Planner".  This app is now called **Planner basic plan**.
...
For simplicity I refer to Project Professional or Project Standard as **Project** and to Planner Basic as **Planner**. Where there are differences between **Planner basic plans** and **Planner premium plans**, I will be explicit in the product names.
## What will Sr. Project Managers miss?

Senior Project Managers will have years of experience using Project and they especially will feel that Planner premium plans lack advanced project management features. My aim is to encourage adoption by identifying the gaps that they’ll miss most to avoid surprises and, at the same time, show them how to bridge those gaps.
...
- How to Mitigate:
	- Use predecessors and successors in Planner premium plans 
...
- How to Mitigate:
	- Use People View in Planner premium plans – This view shows task assignments and allows rebalancing workload manually
...
Senior Project Managers may resist moving to Planner premium plans because it feels like, and in some cases is, a step down from the control and complexity of Project Professional. To win them over:
...
3. Integrated environment – Planner premium plans fit naturally into the Microsoft 365 ecosystem, enhancing teamwork and productivity.

4. Automation and AI – Copilot and Power Automate reduce manual work and improve decision-making.
## Conclusion

For project managers currently using Project Professional as a standalone tool, transitioning to - Planner premium plans will provide them with real-time collaboration, simplified task management, and automation. 
## References
